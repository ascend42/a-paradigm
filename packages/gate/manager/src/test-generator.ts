/**
 * Test file generator from gate.yaml configurations
 */
...
/**
 * Generate test files from a gate.yaml configuration
 *
 * @param gateConfigPath - Path to gate.yaml file
...
import { createGate, setGateClient } from '@horizon/gate-sdk';
import { parseGateConfig } from '@horizon/gate-core';
...
import { checkGateway } from '@horizon/gate-manager';
import { createGate, setGateClient } from '@horizon/gate-sdk';
import { parseGateConfig } from '@horizon/gate-core';
