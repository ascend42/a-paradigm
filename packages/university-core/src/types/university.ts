 ...
 *
 * MOVED to @a-company/university-core (extract-university-core spec §4.5):
 * core owns the MCP-superset type module. paradigm-mcp's
 * src/types/university.ts is now a re-export shim of this module.
 */
 ...
 *
 * Constraints enforced by the Zod schema in pack-schema:
