/**
 * Lore Server - Express server for the Lore Timeline UI
 */
 ...
 */
export function createLoreApp(options: LoreServerOptions): Express {
  const app = express();
 ...
 */
export async function startLoreServer(options: LoreServerOptions): Promise<void> {
