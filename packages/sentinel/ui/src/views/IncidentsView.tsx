/**
 * Incidents View - Incident triage and pattern matching
 */
...
export function IncidentsView() {
  ...
  // Load incidents and patterns on mount
  useEffect(() => {
    loadIncidents();
    loadPatterns();
  ...
  if (isLoading) {
    return (
      <div className="incidents-view loading-state">
  ...
  if (error) {
    return (
      <div className="incidents-view error-state">
              ...
              >
                ...
                {incident.symbols && Object.keys(incident.symbols).length > 0 && (
                  <div className="incident-symbols">
                    {incident.symbols.feature && (
                      <span className="symbol-tag feature">@{incident.symbols.feature}</span>
                    )}
