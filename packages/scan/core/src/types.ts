/**
 * Core types for Horizon Scan - Visual discovery layer for AI agents
 */
...
export interface ScanIndexMeta {
  ...
  generatedAt: string;
  /** Horizon version that generated this */
 ...
 * This is what gets written to .horizon/scan-index.json
 */
...
/**
 * Result structure for horizon scan
 */
export interface ScanResult {
  ...
  /** Gate matches */
  gates: ScanMatch[];
  /** Elements in image that lack horizon coverage */
  uncovered: {
    description: string;
...
/**
 * Scan-specific settings in .horizon config
 */
